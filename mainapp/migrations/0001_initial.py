# Generated by Django 3.0 on 2021-02-27 08:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='products', to='mainapp.Category')),
            ],
        ),
        migrations.CreateModel(
            name='ProductItem',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_items', to='mainapp.Product')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_orders', to='mainapp.Customer', verbose_name='Покупатель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
        ...
        migrations.AddField(
            model_name='cart',
            name='products',
            field=models.ManyToManyField(blank=True, related_name='related_cart', to='mainapp.ProductItem'),
        ),
    ]
